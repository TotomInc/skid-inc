...
skidinc.tutorial.core = function() {
    switch(this.step) {
        case 0:
            ...
            skidinc.console.print('<h>TUTORIAL</h> Welcome to <b>SkidInc</b>, an idle-game with an hacking theme! I\'m a small tutorial explaining how to play this game. Before starting, you don\'t need to have any knowledge in programming or other stuff like this to understand and enjoy the game.', function() {
